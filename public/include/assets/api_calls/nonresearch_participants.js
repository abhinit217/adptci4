const showParticipantsDetails = (details) => {
    let popupContent = new ParticipantsDetails(details).init();
...
class ParticipantsDetails{
    ...
    init(){
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card shadow border-0 mt-3">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <h4 class="text_title mb-2"></h4>
                                    <div class="" id="details-gender-wise" style="width:100%;height: 300px;"></div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6">
        ...
        setTimeout(() => {
            ...
            this.genderWiseChart(this.genderWise);
    ...
    genderWiseChart(chartData){
        let total = chartData["male"] + chartData["female"]
        let malePc = total ? Number(((chartData["male"]*100)/total).toFixed(2)) : 0;
        let femalePc = total ? Number(((chartData["female"]*100)/total).toFixed(2)) : 0;
        let innerTemplate = `
            <div class="card shadow border-0 mt-4">
                <div class="card-body mb-0 pb-3">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <p class="mb-0 text_pos_female"><span>${malePc} %</span></p>
                            <p class="mb-0"><img src="${this.mediaUrl}/include/assets/images/female.png" height="55px"></p>
                            <p class="mb-0 text_small">Female</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0 text_pos_female"> <span>${femalePc} %</span></p>
                            <p class="mb-0"><img src="${this.mediaUrl}/include/assets/images/male.png" height="55px"></p>
        ...
        `;
        $("div#details-gender-wise").empty().html(innerTemplate);
    }
}