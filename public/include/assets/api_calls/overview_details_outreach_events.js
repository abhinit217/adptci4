const showOutreachEventDetails = (details) => {
    let popupContent = new OutreachEventDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}

class OutreachEventDetails{
    constructor(details){
        this.chartColors = [
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            ...
                            <div> <h4 class="text_titles mb-0">Number of outreach events and campaigns conducted</h4></div>
