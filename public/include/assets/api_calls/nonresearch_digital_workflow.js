const showDigitalWorkflowDetails = (details) => {
    let popupContent = new DigitalWorkflowDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}

class DigitalWorkflowDetails{
    constructor(details){
        this.chartColors = [
                    ...
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            <div class="d-flex justify-content-between">
                                <div> <h4 class="text_titles mb-0">Digitized workflows and processes</h4></div>
