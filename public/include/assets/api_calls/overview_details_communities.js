const showCommunitiesDetails = (details) => {
    let popupContent = new CommunitiesDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}

class CommunitiesDetails{
    constructor(details){
        this.chartColors = [
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            ...
                            <div> <h4 class="text_titles mb-0">NUMBER OF COMMUNITIES/VILLAGES REACHED THROUGH ICRISAT INTERVENTIONS</h4></div>
    ...
    countryWiseChart(chartData){
        if(chartData.length){
            Highcharts.chart("details-country-wise", {
                ...
                yAxis: {
                    min: 0,
                    title: {text: "Communities/Villages"},
                    allowDecimals: false
                },
                plotOptions: {
                    column: {
