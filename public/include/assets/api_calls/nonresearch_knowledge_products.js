const showKnowledgeProductDetails = (details) => {
    let popupContent = new KnowledgeProductDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}

class KnowledgeProductDetails{
    constructor(details){
        this.chartColors = [
        ...
        this.cropWise = details["crop_wise"];
        this.scienceOutletWise = details["scienceoutlet_wise"];
        this.mediaOutletWise = details["mediaoutlet_wise"];
    ...
    init(){
                    ...
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            <div class="d-flex justify-content-between">
                                <div> <h4 class="text_titles mb-0">Internal communication feedback, review and engagement</h4></div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <h4 class="text_title mb-2">Knowledge Product</h4>
                                    <div class="" id="details-scienceoutlet-wise" style="width:100%;height: 300px;"></div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <h4 class="text_title mb-2">Media Product</h4>
                                    <div class="" id="details-mediaoutlet-wise" style="width:100%;height: 300px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        setTimeout(() => {
            ...
            this.scienceOutletWiseChart(this.scienceOutletWise);
            this.mediaOutletWiseChart(this.mediaOutletWise);
    ...
    countryWiseChart(chartData){
        if(chartData.length){
            Highcharts.chart("details-country-wise", {
                ...
                series: [
                    {
                        "name": "Knowledge dissemination, communications outreach and stakeholder engagement",
    ...
    cropWiseChart(chartData){
        if(chartData.length){
            ...
            $("div#details-crop-wise").empty().html("Data unavailable");
        }
    }

    scienceOutletWiseChart(chartData){
        if(chartData.length){
            Highcharts.chart("details-scienceoutlet-wise", {
                chart: {type: "column"},
                credits: {enabled: false},
                title: {text: null},
                xAxis: {
            ...
            $("div#details-scienceoutlet-wise").empty().html("Data unavailable");
        }
    }

    mediaOutletWiseChart(chartData){
        if(chartData.length){
            Highcharts.chart("details-mediaoutlet-wise", {
                chart: {type: "column"},
                credits: {enabled: false},
                title: {text: null},
                xAxis: {
            ...
            $("div#details-mediaoutlet-wise").empty().html("Data unavailable");
        }
    }
