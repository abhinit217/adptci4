const showClimateInformationDetails = (details) => {
    let popupContent = new climateInformationDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}

class climateInformationDetails{
    constructor(details){
        this.chartColors = [
                    ...
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            <div class="d-flex justify-content-between">
                                <div> <h4 class="text_titles mb-0">Number of Climate Information service Tools</h4></div>
