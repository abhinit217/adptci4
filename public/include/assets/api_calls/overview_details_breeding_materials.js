const showBreedingMaterialsDetails = (details) => {
    let popupContent = new BreedingMaterialsDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}

class BreedingMaterialsDetails {
    constructor(details) {
        this.chartColors = [
                    ...
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            <div class="d-flex justify-content-between">
                                <div> <h4 class="text_titles mb-0">Number of breeding materials</h4></div>
    ...
    countryWiseChart(chartData) {
        if (chartData.length) {
            Highcharts.chart("details-country-wise", {
                ...
                yAxis: {
                    min: 0,
                    title: { text: "Number of breeding materials" },
                    allowDecimals: false
                },
                plotOptions: {
                    column: {
