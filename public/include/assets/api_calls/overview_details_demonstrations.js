const showDemonstrations = (details) => {
    let popupContent = new Demonstrations(details).init();
...
class Demonstrations{
    constructor(details){
        ...
        this.countryWise = details.country_wise.filter(a => a.count_demo || a.count_trail);
        this.regionWise = details.region_wise.filter(a => a.count_demo || a.count_trail);
        this.clusterWise = details.cluster_wise.filter(a => a.count_demo || a.count_trail);
                    ...
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            <div class="d-flex justify-content-between">
                                <div> <h4 class="text_titles mb-0">Number of demonstrations/benchmark sites established</h4></div>
                ...
                series: [
                    {
                        ...
                        "data": chartData.map((a, i) => {
                            return {"y": a.count_demo, "color": this.chartColors[i]};
                        })
                    },
                    {
                        "name": "sites",
                        "data": chartData.map((a, i) => {
                            return {"y": a.count_trail, "color": this.chartColors[i]};
                        })
                    }, 
                ]
            });
