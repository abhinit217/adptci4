const showTechnologiesDetails = (details) => {
    let popupContent = new TechnologiesDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}

class TechnologiesDetails{
    constructor(details){
        this.chartColors = [
                    ...
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            <div class="d-flex justify-content-between">
                                <div> <h4 class="text_titles mb-0">Number of ICRISAT technologies upscaled</h4></div>
