const showDigitalToolsDetails = (details) => {
    let popupContent = new DigitalToolsDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}

class DigitalToolsDetails{
    constructor(details){
        this.chartColors = [
                    ...
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            <div class="d-flex justify-content-between">
                                <div> <h4 class="text_titles mb-0">Number of digital tools and platforms developed</h4></div>
    ...
    countryWiseChart(chartData){
        if(chartData.length){
            Highcharts.chart("details-country-wise", {
                ...
                yAxis: {
                    min: 0,
                    title: {text: "Number of digital tools"},
                    allowDecimals: false
                },
                plotOptions: {
                    column: {
            ...
            $("#details-country-wise").css("height", "50px").html(`<div class="text-center my-auto">Data unavailable`);
        }
    }
    ...
    indicatorWiseNumbers(chartData){
        if(chartData.length){
            ...
            $("#details-indicator-wise").css("height", "50px").html(`<div class="text-center my-auto">Data unavailable`);
        }
    }
    ...
    regionWiseChart(chartData){
        if(chartData.length){
            ...
            $("#details-region-wise").css("height", "50px").html(`<div class="text-center my-auto">Data unavailable`);
        }
    }
    ...
    clusterWiseChart(chartData){
        if(chartData.length){
            ...
            $("#details-cluster-wise").css("height", "50px").html(`<div class="text-center my-auto">Data unavailable`);
        }
    }
    ...
    sdgWiseChart(sankeyData){
        if(sankeyData.length){
            ...
            $("#details-sdg-wise").css("height", "50px").html(`<div class="text-center my-auto">Data unavailable`);
        }
    }
}