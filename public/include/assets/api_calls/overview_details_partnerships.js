const showPartnershipDetails = (details) => {
    let popupContent = new PartnershipDetails(details).init();
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            ...
                            <div> <h4 class="text_titles mb-0">NUMBER OF PARTNERSHIPS DEVELOPED</h4></div>
