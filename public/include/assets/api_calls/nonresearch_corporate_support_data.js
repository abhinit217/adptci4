const showCorporateSupportDetails = (details) => {
    let popupContent = new CorporateSupportDetails(details).init();
    $("#details-modal-container").empty().html(popupContent);
}


class CorporateSupportDetails{
    constructor(details){
        this.chartColors = [
                    ...
                    <div class="card shadow border-0 mt-3">
                        <div class="card-header border-bottom-0">
                            <div class="d-flex justify-content-between">
                                <div> <h4 class="text_titles mb-0">Rationalization, restructuring and re-energising corporate support functions and units</h4></div>
