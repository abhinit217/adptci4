			...
			<div class="col-md-12 mt-3">
				...
				<?php if(count($form_data) > 0){
					...
					foreach ($form_data as $key => $data) { 
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card" style="margin-bottom: 65px;padding-bottom: ;">
									<div class="card-body">
										<div class="row" id="data_<?php echo $key; ?>">
											<div class="col-md-12">
												<div class="row">
													<div class="col-md-2">
														<b>Reporting Year:</b> <?php echo ($data['yearname'] == NULL) ? "N/A" : $data['yearname'];?>
													</div>
													<div class="col-md-2">
														<b>Reporting Period:</b> <?php echo ($data['rpname'] == NULL) ? "N/A" : $data['rpname'];?>
													</div>
													<div class="col-md-3">
														<b>Country/ Region:</b> <?php echo ($data['cname'] == NULL) ? "N/A" : $data['cname'];?>
													</div>
													<div class="col-md-2">
														<b>Crop:</b> <?php echo ($data['crname'] == NULL) ? "N/A" : $data['crname'];?>
													</div>
											...
											<div class="col-md-12">
												<div class="row">
													...
													<div class="col-md-2">
														<p class=""><?php if($data['status'] == 4){ ?>
															Status: <span class="text-success"><b>Data rejected</b></span>
														<?php } ?></p>
													...
													<div class="col-md-2">
													<?php if($data['useaprrname']!=''){?><p class="pull-left">Rejected by: <?php echo $data['useaprrname']; ?></p>
													<?php } ?></div>
													<div class="col-md-2">
														<?php if($data['rejected_date']!='') { ?><p class="pull-right"> Rejected on: <?php echo $data['rejected_date']; ?> (UTC)</p><?php } ?>
													</div>
													<div class="col-md-2">
											...
											<div class="col-md-12">
												<!-- <?php if(($data['user_id'] == $this->session->userdata('login_id') && ($data['status'] == 2 || $data['status'] == 1)) || $this->session->userdata('role') == 6 || $this->session->userdata('role') == 5 || $this->session->userdata('role') == 4){ ?>
													<a href="javascript:void(0);" class="pull-right delete_data" style="color: red;" data-recordid = "<?php echo $data['data_id']; ?>"><i class="fa fa-trash" style="font-size:18px;"></i> Delete rejected record</a>
												<?php } ?> -->
												...
												<?php if($data['status'] == 2 && ($this->session->userdata('role') != 6 || ($data['user_id'] == $this->session->userdata('login_id')))){ ?>
													...
													<a href="<?php echo base_url(); ?>reporting/edit_data/<?php echo $data['form_id'];?>/<?php echo $data['year_id'];?>/<?php echo $data['id'];?>/<?php echo $data['status'];?>" target="_blank" class="pull-right " style="color: blue; margin-right: 15px;" ><i class="fa fa-pencil" style="font-size:18px;"></i> Edit</a>
												<?php } ?>
												...
												<?php if(($data['user_id'] == $this->session->userdata('login_id')) && $data['status'] == 4){ ?>
													<!-- <a href="javascript:void(0);" class="pull-right getfields_tosubmit_savedata" style="color: blue; margin-right: 15px;" data-urole ="<?php echo $this->session->userdata('role'); ?>" data-recordid = "<?php echo $data['data_id']; ?>" data-formtype="edit"><i class="fa fa-pencil" style="font-size:18px;"></i> Edit rejected data</a> -->
													<a href="<?php echo base_url(); ?>reporting/edit_data/<?php echo $data['form_id'];?>/<?php echo $data['year_id'];?>/<?php echo $data['id'];?>/<?php echo $data['status'];?>" target="_blank" class="pull-right " style="color: blue; margin-right: 15px;" ><i class="fa fa-pencil" style="font-size:18px;"></i> Edit rejected data</a>
												<?php } ?>

												<?php if($this->session->userdata('role') == 6 && $data['status'] == 3){ ?>
													<button type="button" class="btn btn-sm btn-warning pull-right send_back" data-recordid="<?php echo $data['data_id']; ?>" data-by="<?php echo $data['username']; ?>" style="margin-top: -10px; margin-right:10px;">Send Back</button>
												<?php } ?>
											</div>
											...
											<div class="col-md-12 mt-10">
												<?php if (isset($group_array) && (count($data) > 0)) {
													foreach ($group_array as $key => $group) { ?>
														...
														<a href="<?php echo base_url(); ?>reports/edit_groupdata_info/<?php echo $data['form_id'];?>/<?php echo $data['data_id'];?>/<?php echo $data['groupdata'][$key]['groupfield_id'];?>/<?php echo $data['status'];?>" target="_blank" class="pull-right " style="color: blue; margin-right: 15px;" ><i class="fa fa-pencil" style="font-size:18px;"></i> Edit group data</a>
														<div class="table-responsive">
									        				<table class="table table-bordered" id="datatable">
																<thead>
																	<tr style="background-color:#050c43;">
																		...
																		foreach ($data['groupdata'] as $gkey => $g_data) { 
																			...
																			if($group['group_lable']['field_id'] == $g_data['groupfield_id']){ ?>
																				<tr id="data_<?php echo $key; ?><?php echo $gkey; ?>">
																					...
																					<?php }
																					if((($data['status'] == 2 || $data['status'] == 1) && ($data['user_id'] == $this->session->userdata('login_id'))) || $this->session->userdata('role') == 6 || $this->session->userdata('role') == 5 || $this->session->userdata('role') == 4){ ?>
																						<td>
											...
											<div class="col-md-12"></div>
											<?php 
                                                $progrm_id = $this->uri->segment('7');
                                                if($progrm_id!=4 ) {
													$sdg_count=0;
                                                    ?>
                                                    <div class="col-sm-12 col-md-12 form-group">
                                                        <div><b>Selected SDGs :</b>
															</div><br/>                                                 
                                                        <?php foreach ($data['sdg_list'] as $key => $option) { 
															$sdg_count++;
															?>
                                                            <ul class="ul-list goal1">
                                                                ...
                                                                <?php 
                                                                foreach ($data['sdg_sub_list'] as $key => $suboption) { 
                                                                    if($option['sdg_id']==$suboption['sdg_id']){?>
                                                                        <li class="sdg_list">
                                                                        <label style="font-weight:400;"><?php echo $suboption['sdg_sub_name']; ?></label>
                                                                        </li>
                                                                    <?php 
                                                                    }
                                                                } ?>
											...
											<div class="col-md-12">
												<?php 
												$file_count=0;
													foreach ($data['file_list_array'] as $flkey => $filelist) {
														$file_count++; 
														if(count($data['file_list_array'])){
															?>	
															<div calss="col-md-2">
															<b>Upload file: <a href="<?php echo base_url(); ?>/upload/survey/<?php echo $filelist['file_name'];?>" target="_blank" style="color:blue;text-decoration: underline;" download>Download File</a></b>
															</div>
															<?php
														}else{
															?>
                    	...
                    	var form_fields = '<form id="submit_data">';
                    		form_fields += '<div class="row">';
																							...
																							form_fields += '<div class="form-check">\
																						    	<div class="row">';
																						    		indicatorgroupfield.options.forEach(function(option, index){
													        											...
													        											if(jQuery.inArray(option.trait_description, checkbox_val) !== -1){
																                                			var radio_value = "checked"; 
																                                		}else{
																                                			var radio_value = '';
																                                		}
																						    			form_fields += '<div class="col-md-6">\
																						          			<label><input type="checkbox" name="field_'+indicatorgroupfield.field_id+'['+groupdata_index+'][]" value = "'+option.trait_description+'" style="margin-right: 5px;" data-field_id = "'+indicatorgroupfield.field_id+'" data-field_value = "'+option.trait_description+'" data-required="'+requiredval+'" '+radio_value+' >'+option.trait_name+'</label>\
																						        		</div>';
																						    		});
																						    	form_fields += '</div>\
																						  	</div>\
																							...
																							form_fields += '<div class="form-check">\
																						    	<div class="row">';
																						    		indicatorgroupfield.options.forEach(function(option, index){
													        											...
													        											if(jQuery.inArray(option.trait2_description, checkbox_val) !== -1){
																                                			var radio_value = "checked"; 
																                                		}else{
																                                			var radio_value = '';
																                                		}
																						    			form_fields += '<div class="col-md-6">\
																						          			<label><input type="checkbox" name="field_'+indicatorgroupfield.field_id+'['+groupdata_index+'][]" value = "'+option.trait2_description+'" style="margin-right: 5px;" data-field_id = "'+indicatorgroupfield.field_id+'" data-field_value = "'+option.trait2_description+'" data-required="'+requiredval+'" '+radio_value+' >'+option.trait2_name+'</label>\
																						        		</div>';
																						    		});
																						    	form_fields += '</div>\
																						  	</div>\
								...
								if(response.get_tabledata.status==1){
									...
									form_fields += '<div class="col-md-12">\
										<button type="button" class="btn btn-sm btn-success pull-right submitindicator_data" style="margin-top: 50px;" data-formtype = "'+formtype+'" data-recordid = "'+recordid+'">Resubmit data</button>\
										<button type="button" class="btn btn-sm btn-default pull-right cancel" style="margin-top: 50px; margin-right:10px;">Cancel</button>\
									</div>';
								}
							form_fields += '</div>\
