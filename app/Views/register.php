                        ...
                        <div class="col-sm-12 col-md-10 col-lg-10">
                                    ...
                                    <div class="card pl-3 pr-3 pt-0 shadow border-0" id="loginCard">
                                        <nav class="nav-justified">
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <!-- <a class="nav-item nav-link p-3 text-dark" id="nav-profile-tab"
                                                    data-toggle="tab" href="#nav-profile" role="tab"
                                                    aria-controls="nav-profile" aria-selected="false"> Sign in</a> -->
                                                    <a class="nav-item nav-link p-3 text-dark"  href="<?php echo base_url(); ?>login">Sign in</a>
                            ...
                            <div class="row text-center">
                                <div class="col-sm-12 mt-3">
                                    <a href="<?php echo base_url(); ?>" class="text-dark py-0 px-4">Back to Home</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-1 col-lg-1"> </div>
