                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr class="bg-header bg-light">
                                        <th>Measurement level : <select class="form-control measure_level col-sm-12 col-md-6 col-lg-6" name="measure_level" id="measure_level">
                                        ...
                                        <th> Year : <select class="form-control" name="year">
                                        ...
                                        <th>Country : <select class="form-control country" name="country">
