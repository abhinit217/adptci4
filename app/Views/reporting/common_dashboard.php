                            ...
                            <div class="card border-0 shadow">
                                <div class="card-header bg-white">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="">
                                            <h3 class="title mb-0">Dashboard</h3>
                                        </div>
                                        <!-- <div class="">
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 mb-5">
                                                    <div class="card border card-hover">
                                                        ...
                                                        <div class="card-footer bg-white">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                                                                    <h4 class="title">Kenya Country Profile</h4>
                                                                </div>
                                                                <div>
                                                                    ...
                                                                    <a href="<?php echo base_url(); ?>reporting/c_dashboard/1" class="goDim cursor"> <img src="<?php echo base_url(); ?>/include/assets/images/Arrow_Right.svg"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 mb-5">
                                                    <div class="card border card-hover">
                                                        ...
                                                        <div class="card-footer bg-white">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                                                                    <h4 class="title">Ethiopia Country Profile</h4>
                                                                    </div>
                                                                <div>
                                                                    ...
                                                                    <a href="<?php echo base_url(); ?>reporting/c_dashboard/3" class="goDim cursor"> <img src="<?php echo base_url(); ?>/include/assets/images/Arrow_Right.svg"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 mb-5">
                                                    <div class="card border card-hover">
                                                        ...
                                                        <div class="card-footer bg-white">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                                                                    <h4 class="title">Uganda Country Profile</h4>
                                                                    </div>
                                                                <div>
                                                                    ...
                                                                    <a href="<?php echo base_url(); ?>reporting/c_dashboard/2" class="goDim cursor"> <img src="<?php echo base_url(); ?>/include/assets/images/Arrow_Right.svg"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
