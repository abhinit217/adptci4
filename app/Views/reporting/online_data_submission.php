                ...
                <div class="p-3 pl-0 bg-light border border-bottom-0">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="year_id" class="form-control lkp_year" data-required = "required">
                                                    ...
                                                    <?php foreach ($lkp_year_list as $key => $option) { 
                                                        if($this->uri->segment('4')==2 && $option['year_id']==1){
                                                            //skipping 2021 year for 2022 submition
                                                        }else{
                                                            if($this->uri->segment('4')==1 && $option['year_id']==2){
                                                                //skipping 2022 year for 2021 submition for Asia program
                                                            }else{
                                                            ?>
                            ...
                            <div class="col-md-12 indicatorFieldsDiv hidden">
                                <div class="card">
                                            ...
                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="<?php echo $cluster_select_boxname; ?>" <?php echo $cluster_multiple_selectval; ?> class="<?php echo $indicatorfield['className']; ?>" data-required = "<?php echo ($indicatorfield['required'] == 1) ? 'required' : ''; ?>">
                                                                            ...
                                                                            <?php foreach ($indicatorfield['options'] as $key => $option) { ?>
                                                                                <option value = "<?php echo $option['cluster_id']; ?>"><?php echo $option['cluster_name']; ?></option> <?php
                                                                            } ?>
                                                                        </select>
                                                                        <p class="error red-800"></p>
                                                                    </div>
                                                ...
                                                if($progrm_id!=4) {
                                                    ...
                                                    <div class="col-sm-12 col-md-12 form-group">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Does this indicator contribute to any SDGs<font color='red'>*</font></label>
                                                                <div class="form-check">
                                                                    <div class="row">
                                                                            <div class="col-md-6">
                                                                                <label><input type="radio" name="field_sdg" class="field_sdg" value="Yes" style="margin-right: 5px;" >Yes</label>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <label><input type="radio" name="field_sdg" class="field_sdg" value="No" style="margin-right: 5px;">No</label>
                                                                            </div>
                                                                    </div>
                                                                </div>
                                                                <p class="error" style="color: red"><p>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 form-group sdg_div hidden">
                                                            ...
                                                            <ul class="ul-list goal1">
                                                                ...
                                                                foreach ($lkp_sdg_sub as $key => $suboption) { 
                                                                    if($option['sdg_id']==$suboption['sdg_id']){?>
                                                                        <li class="sdg_list">
                                                                        <label style="font-weight:400;"><input type="checkbox" name="sdg_id" value="<?php echo $suboption['sdg_sub_id']; ?>" style="margin-right: 5px;"  data-field_value="<?php echo $suboption['sdg_sub_id']; ?>" data-fieldtype="normalfield" ><?php echo $suboption['sdg_sub_name']; ?></label>
                                                                        </li>
                                                                    <?php 
                                                                    }
                                                                } ?>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-success pull-right save_data" style="margin-right:10px;">Save data</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    case 'number':
                        if ($(this).val().length > 0) {
                            if (/^\d+$/.test($(this).val())) {
                                ...
                                $(this).val('');
                                $(this).next('.error').html('Please enter number only');
                                surveycount++;
                            }
                        }
                        break;
