                                 ...
                                 <tr>
                                    ...
                                    <td align="center">
                                       <a target="_blank" href="<?php echo base_url(); ?>">
                                          <img border="0" height="100" alt="" border="0" style="display:block; border:none; outline:none; width: auto; text-decoration:none; padding:10px 0; border-bottom:2px solid #CCCCCC;" src="<?php echo base_url(); ?>include/assets/images/mpro-images/logo.png" class="logo">
                                       </a>
                                    </td>
                                 </tr>
                              </tbody>
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #333333; text-align:left;line-height: 24px;">
                                                   We received a request to reset your password for AVISA account. We're here to help! 
                                                </td>
                                             </tr>
                                             <!-- End of content -->
                                             <!-- Spacing -->
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #ffffff">
                                       You have received this email because you requested that your password be changed at <a href="<?php echo base_url(); ?>"><font color="white">AVISA App</font></a>
                                    </td>
                                 </tr>
                                 <!-- Spacing -->
                                 <tr>
